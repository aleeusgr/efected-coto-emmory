<div align="center">
  <a href="https://github.com/aleeusgr/efected-coto-emmory" target="_blank">
    <img src="https://raw.githubusercontent.com/aleeusgr/efected-coto-emmory/main/assets/a_logo.png" alt="efected-coto-emmory Logo" width="100"></img>
  </a>

  <h1 align="center">efected-coto-emmory</h1>

  <p>
    <a href="https://crates.io/crates/efected-coto-emmory">
      <img src="https://img.shields.io/crates/v/efected-coto-emmory?label=crates" alt="Crate">
    </a>
    <a href="https://github.com/aleeusgr/efected-coto-emmory/blob/main/LICENSE-APACHE">
      <img src="https://img.shields.io/badge/License-Apache%202.0-blue.svg" alt="License-Apache">
    </a>
    <a href="https://github.com/aleeusgr/efected-coto-emmory/blob/main/LICENSE-MIT">
      <img src="https://img.shields.io/badge/License-MIT-blue.svg" alt="License-MIT">
    </a>
    <a href="https://docs.rs/efected-coto-emmory">
...
- [Running efected-coto-emmory on Docker](#running-efected-coto-emmory-on-docker)
...
* `3000`: main `efected-coto-emmory` application, including `/healthcheck`, etc.
* `4000`: `/metrics`
...
`efected-coto-emmory` contains a file for [configuration settings](./config/settings.toml),
...
[integration test](./efected-coto-emmory/tests/integration_test.rs),
...
*Note*: Our [logging middleware](./efected-coto-emmory/src/middleware/logging.rs)
...
[middleware/client.metrics.rs](./efected-coto-emmory/src/middleware/client/metrics.rs).
For the `axum` webserver itself, metrics are derived via
[middleware/metrics.rs](./efected-coto-emmory/src/middleware/metrics.rs).
...
## Running efected-coto-emmory on Docker
...
- Build a multi-plaform Docker image via [buildx][buildx]:
  ...
  ```console
  docker buildx build --platform=linux/amd64,linux/arm64 -t efected-coto-emmory --progress=plain .
  ```

- Run a Docker image (depending on your platform):

  ```console
  docker run --platform=linux/amd64 -t efected-coto-emmory
  ```
...
For logs, traces, and metrics, `efected-coto-emmory` utilizes several log levels
...
to capture everything flowing through `efected-coto-emmory` before events are
diffracted to their respective log levels--this way it is possible for
`efected-coto-emmory` to maintain contextual trace information throughout the
...
`efected-coto-emmory` implements hooks around the creation and closing of spans
...
#[instrument(
    level = "info",
    name = "efected-coto-emmory.songs.handler.POST",
    skip_all,
...
setting OTEL span information when `efected-coto-emmory` application
